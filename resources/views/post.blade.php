                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="single-post-thumb d-flex justify-content-center">
                            <img class="img-fluid" src="{{$post->photo ? asset($post->photo->file) : 'http://via.placeholder.com/800x600'}}" alt="{{$post->title}}">
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="single-post-text">
                            <p>Suspendisse scelerisque tellus convallis tortor posuere, ut commodo diam blandit. Morbi
                                vel nulla non turpis luctus tempor eu eu urna. Aliquam in lorem a augue mollis volutpat.
                                Nunc iaculis rutrum enim nec viverra. Morbi eleifend metus id tellus luctus, ac porta
                                orci imperdiet.</p>

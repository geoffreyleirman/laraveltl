                        ...
                        @foreach($post->postcomments as $postcomment)
                            @if($postcomment->is_active == 1)
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-md-flex align-items-start">
                                        ...
                                        <div class="comment-author">
                                            <img class="rounded-circle"
                                                 src="{{$postcomment->user->photo ? $postcomment->user->photo->file : 'http://via.placeholder.com/70x70'}}"
                                                 alt="">
                                        </div>
                                        <!-- Comment Content -->
                                    ...
                                    <textarea class="form-control bg-white text-black border" name="body" id="body"
                                              cols="30" rows="10"
                                              placeholder="Description"></textarea>
                                                            </div>
                                                            <button type="submit" class="btn leave-comment-btn">SUBMIT
                                                                <i
                                    ...
                                    @can('update', $postcomment)
                                        ...
                                        @foreach($postcomment->postcommentreplies as $postcommentreply)
                                            ...
                                            <div class="comment-wrapper d-md-flex align-items-start">
                                                ...
                                                <!-- Comment Content -->
                                                <div class="comment-content">
                                                    <h5>{{$postcommentreply->user->name}}</h5>
                                                    <span class="comment-date text-muted">{{$postcommentreply->created_at->diffForHumans()}}</span>

...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">LARAVEL TDL</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTasks" class="collapse" aria-labelledby="collapseTasks" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Task Pages:</h6>
                    <a class="collapse-item" href="{{route('tasks.index')}}">All Tasks</a>
                </div>
            </div>
        </li>
